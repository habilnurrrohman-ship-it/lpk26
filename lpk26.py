...
# --- BAB I ---
    ...
    * Sangat reaktif karena memiliki ikatan rangkap ($\text{C}=\text{C}$ atau $\text{C}\equiv\text{C}$) yang kaya akan elektron, sehingga mudah mengalami pemuntungan ikatan rangkap (adisi).
...
# --- POST TEST (HANYA SMART FLOWCHART) ---
    ...
    st.write("Sistem ini mensimulasikan penelusuran Identifikasi Kualitatif langkah langkah. Tekan tombol *Next* untuk melanjutkan ke tahap reaksi berikutnya.")
